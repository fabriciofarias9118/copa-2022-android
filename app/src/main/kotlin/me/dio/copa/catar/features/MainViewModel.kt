...
import me.dio.copa.catar.domain.usecase.DisableNotifitcationUseCase
...
class MainViewModel @Inject constructor(
    ...
    private val disableNotifitcationUseCase: DisableNotifitcationUseCase,
            ...
            runCatching {
                withContext(Dispatchers.Main){
                    val action = if (match.notificationEnabled){
                        disableNotifitcationUseCase(match.id)
